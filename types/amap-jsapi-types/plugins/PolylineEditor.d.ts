export type PolylineEditorEventType = 'addnode' | 'adjust' | 'removenode' | 'end' | 'move' | 'add';
...
export class _PolylineEditor extends AMap.Event<PolylineEditorEventType> {
  constructor(map: AMap.Map, polyline?: AMap.Polyline, options?: PolylineEditorOptions);
