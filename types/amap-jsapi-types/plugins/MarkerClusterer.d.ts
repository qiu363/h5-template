...
export interface MarkerClustererOptions {
   ...
   */
  renderMarker?: (o: RenderClusterMarkerObject) => void;
...
export class _MarkerClusterer extends AMap.Event<'click'> {
  constructor(map: AMap.Map, markers: MarkerOptions[], options: MarkerClustererOptions);

  /** 在原数据基础上添加数据 */
  public addData: (data: MarkerOptions[]) => void;

  /** 设置数据 */
  public setData: (data: MarkerOptions[]) => void;
