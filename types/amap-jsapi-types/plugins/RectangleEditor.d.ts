export type RectangleEditorEventType = 'addnode' | 'adjust' | 'removenode' | 'end' | 'move' | 'add';
...
export class _RectangleEditor extends AMap.Event<RectangleEditorEventType> {
  constructor(map: AMap.Map, circle?: AMap.Rectangle, options?: RectangleEditorOptions);
